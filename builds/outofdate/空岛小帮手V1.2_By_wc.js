...
//方块
Block.defineBlock(255,"挖石机",[["redstone_block",0],["stone",2],["stone",0],["stone",0],["stone",0],["stone",0]],245,false,0);
...
//常量
const JsVersion = "1.2",GameVersion = ModPE.getMinecraftVersion();
...
//GUI
var gui,MP3,mp3seek,mp3button,mapop,logo,logoimg,logotext,alpha,zoop,shoot,pos;
//各种变量
...
var dead = false,sxp,sid = new Array(),sdata = new Array(),scount = new Array();
...
var adapter=new android.widget.ArrayAdapter(ctx,android.R.layout.select_dialog_multichoice,new java.lang.String("未选择,岩浆粒子,火点粒子,爆炸粒子,云烟粒子,红石粒子,物品粒子,方块粒子,火焰粒子,爱心粒子,停止的水,末影粒子,水滴粒子,苏醒的水,滴水粒子,滴落岩浆,变色粒子,药水粒子,墨水粒子").split(","))
